        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="text-center lg:text-left order-2 lg:order-1 animate-slide-in-left">
            ...
            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold mb-6">
              ...
              <span className="block text-gradient animate-gradient">Haseeb</span>
            </h1>
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 mb-8 max-w-2xl leading-relaxed">
              ...
              CKA & CKAD Certified | Software Engineer @ Silicon Valley Startup with ex-AWS Visionaries
            </p>
          ...
          <div className="order-1 lg:order-2 flex justify-center animate-slide-in-right">
            <div className="relative">
              ...
              <div className="relative w-64 h-64 sm:w-80 sm:h-80 lg:w-96 lg:h-96">
                <div className="absolute inset-0 rounded-full bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 animate-gradient" style={{ backgroundSize: '200% 200%' }}></div>
              ...
              <div className="absolute -top-4 -left-4 glass dark:glass-dark px-6 py-3 rounded-2xl shadow-xl">
                ...
                <div className="text-xs text-gray-600 dark:text-gray-400">K8s Add-ons</div>
              </div>
            </div>
          </div>
        </div>
